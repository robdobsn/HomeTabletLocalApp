...
DomoticzServer = (function() {
  ...
  DomoticzServer.prototype.reqActions = function() {
    console.log("Requesting Domoticz data from " + this.ACTIONS_URI);
    $.ajax(this.ACTIONS_URI, {
      ...
      success: (function(_this) {
        return function(data, textStatus, jqXHR) {
          ...
          console.log("Received Domoticz data from " + _this.ACTIONS_URI);
      ...
      error: (function(_this) {
        return function(jqXHR, textStatus, errorThrown) {
          var storedData;
          LocalStorage.logEvent("DomLog", "AjaxFail Status= " + textStatus + " URL= " + _this.ACTIONS_URI + " Error= " + errorThrown);
  ...
  DomoticzServer.prototype.getScenes = function(data, rooms) {
    var actionName, name, roomName, scene, scenes, serverScene, serverScenes, _i, _len;
    serverScenes = data.result;
    scenes = [];
    if (serverScenes != null) {
      for (_i = 0, _len = serverScenes.length; _i < _len; _i++) {
        serverScene = serverScenes[_i];
