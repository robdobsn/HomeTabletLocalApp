...
(function() {
  App.TabPage = (function() {
    ...
    TabPage.prototype.handlePageNav = function(pageNav) {
      var _, j, len, navAction, ref, ref1, tile, tileName;
      ref = pageNav.match(/\~(.*)\?(.*)/), _ = ref[0], tileName = ref[1], navAction = ref[2];
      ref1 = this.tiles;
    ...
    TabPage.prototype.updateDom = function() {
      var col, colIdx, colXPos, j, k, len, len1, newTile, ref, ref1, ref2, sizeX, sizeY, tile, tileDef, title, x, y;
      this.calcLayout();
      this.removeAll();
      ...
      if (this.pageDef.tiles != null) {
        ...
        for (k = 0, len1 = ref1.length; k < len1; k++) {
          ...
          ref2 = this.getCellPos(tile), x = ref2[0], y = ref2[1], sizeX = ref2[2], sizeY = ref2[3];
