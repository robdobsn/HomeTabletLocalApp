...
TabPage = (function() {
  ...
  TabPage.prototype.calcLayout = function() {
    var autoAddColIdx, col, colDef, colIdx, colToCopy, colType, colsToAdd, i, isPortrait, numTilesInAutoCol, tile, winHeight, winWidth, _i, _j, _k, _l, _len, _len1, _len2, _ref, _ref1, _ref2;
    ...
    if (colsToAdd > 0) {
      ...
      for (i = _k = 0; 0 <= colsToAdd ? _k < colsToAdd : _k > colsToAdd; i = 0 <= colsToAdd ? ++_k : --_k) {
        this.columnsDef.splice(autoAddColIdx, 0, colToCopy);
      }
    }
    if (this.columnsDef != null) {
      this.tilesAcross = 0;
      _ref2 = this.columnsDef;
      for (colIdx = _l = 0, _len2 = _ref2.length; _l < _len2; colIdx = ++_l) {
        colDef = _ref2[colIdx];
