...
AppPages = (function() {
  ...
  AppPages.prototype.setCurrentPage = function(pageName, forceSet) {
    if ((this.tabletConfig.configData != null) && (this.tabletConfig.configData.pages != null)) {
      if (pageName in this.tabletConfig.configData.pages) {
        if (forceSet || (this.curPage.pageName !== pageName)) {
          this.curPage = this.tabletConfig.configData.pages[pageName];
          return true;
        }
  ...
  AppPages.prototype.build = function(tabletConfig, automationActionGroups) {
    ...
    _ref = this.tabletConfig.configData.pages;
    _results = [];
    for (pageName in _ref) {
      ...
      _results.push(this.generatePageContents(pageDef));
    }
    return _results;
  };

  AppPages.prototype.generatePageContents = function(pageDef) {
    var key, newTile, source, sourceList, tile, tileGen, tileList, tileSource, uniqList, val, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2;
    if ("tileGen" in pageDef) {
      ...
      for (_l = 0, _len3 = tileList.length; _l < _len3; _l++) {
        tile = tileList[_l];
        pageDef.tiles.push(tile);
      }
    }
  ...
  AppPages.prototype.generateNewPage = function(context) {
    ...
    if ((context.pageGenRule != null) && context.pageGenRule !== "") {
      if (context.pageGenRule in this.tabletConfig.configData.pageGen) {
        pageGen = this.tabletConfig.configData.pageGen[context.pageGenRule];
        this.generatedPage = {
        ...
        this.generatePageContents(this.generatedPage);
