...
(function() {
  App.IndigoTestServer = (function() {
    function IndigoTestServer(manager, serverDef, dataReadyCallback) {
      this.manager = manager;
      this.serverDef = serverDef;
      this.dataReadyCallback = dataReadyCallback;
    }

    IndigoTestServer.prototype.reqActions = function() {
      var testActions;
      testActions = [
        {
          "name": "Grace - Bright",
    ...
    IndigoTestServer.prototype.sortByRoomName = function(a, b) {
    ...
    IndigoTestServer.prototype.getScenes = function(data, rooms) {
